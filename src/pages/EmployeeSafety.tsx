              ...
              {openSection && (
                <div style={st.detailPanel} key={openSection}>
                  ...
                  {openSection === 'attestation' && (demoBasic
                    ? <NotApplicableBlock
                        text="Карта умов праці в системі Документообігу відсутня"
                        callout="Ваше робоче місце було атестоване у 2018 році. Умови праці на робочому місці допустимі. Через дію воєнного стану строки проведення чергової атестації продовжені відповідно до законодавства, тому результати попередньої атестації залишаються чинними. Підстав для занепокоєння немає."
                      />
