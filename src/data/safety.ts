...
/* Чи доступна Карта умов праці в docNet (перемикач фолбек-сценарію атестації):
   true  — карта є: колаут з посиланням на docNet
   false — карти немає: заспокійливий текст про чинність попередньої атестації (воєнний стан) */
export const attestationCardInDocNet = true;
